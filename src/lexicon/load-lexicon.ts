...
const DEFAULT_BE_KEYWORD_HINTS: Record<string, string> = {
  ...
  'reuse api': '#reuse-api',
  'reuse-api': '#reuse-api',
  'shared api': '#reuse-api',
  'common endpoint': '#reuse-api',
  'existing api': '#reuse-api',
  'reuse endpoint': '#reuse-api',
  external: '#call-external',
  webhook: '#call-external',
  payment: '#call-external',
  oauth: '#call-external',
  sms: '#call-external',
  'third party': '#call-external',
  'third-party': '#call-external',
  integration: '#call-external',
  'cross service': '#cross-service',
  'cross-service': '#cross-service',
  'cross entity': '#cross-entity-service',
  'cross-entity': '#cross-entity-service',
  orchestration: '#cross-service',
  choreography: '#cross-service',
  'derived data': '#derived-data',
  derived: '#derived-data',
  'computed field': '#derived-data',
  'computed data': '#derived-data',
}
